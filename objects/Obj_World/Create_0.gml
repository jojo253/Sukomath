...
global.debug_brand_button = ord("B")
...
global.save_default[SAVE.ROOM] = "r0";
...
// operation time and cooldown
#macro opertime 1
#macro cdtime 10
// cdwalk is the hold time when player reach a cell.
// cdwalk must > opertime, otherwise operator moves 4*(opertime-cdwalk)px after operating.
#macro cdwalk 2

// craft
global.box_selected="Player"
global.box_brand=noone
